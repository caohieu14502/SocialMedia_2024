...
export const Notification = ({noti_infor}) => {
    console.log(noti_infor)

    return (
        <div id="toast-notification" className="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300 transition ease-in-out duration-300 opacity-100 z-50" role="alert">
            ...
            <div className="flex items-center">
                ...
                <div className="ms-3 text-sm font-normal">
                    <div className="text-sm font-semibold text-gray-900 dark:text-white">{noti_infor.message.user||"Andre Alba"}</div>
                    <div className="text-sm font-normal">{noti_infor.message.content||noti_infor.message}</div> 
