...
var require_router_cjs = __commonJS({
  "node_modules/@remix-run/router/dist/router.cjs.js"(exports) {
    ...
    var ResultType = function(ResultType2) {
  ...
  "node_modules/react-router/dist/umd/react-router.development.js"(exports, module) {
    (function(global, factory) {
      ...
      function useOutlet(context) {
        ...
        if (outlet) {
          return React__namespace.createElement(OutletContext.Provider, {
            value: context
          }, outlet);
        }
        return outlet;
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
        ...
        if (locationArg && renderedMatches) {
          return React__namespace.createElement(LocationContext.Provider, {
            value: {
              location: _extends({
                pathname: "/",
                search: "",
      ...
      function DefaultErrorComponent() {
        ...
        let devInfo = null;
        {
          ...
          devInfo = React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement("p", null, "💿 Hey developer 👋"), React__namespace.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", React__namespace.createElement("code", {
            style: codeStyles
          }, "ErrorBoundary"), " or", " ", React__namespace.createElement("code", {
            style: codeStyles
          }, "errorElement"), " prop on your route."));
        }
        return React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement("h2", null, "Unexpected Application Error!"), React__namespace.createElement("h3", {
          style: {
            fontStyle: "italic"
          }
        }, message), stack ? React__namespace.createElement("pre", {
          style: preStyles
        }, stack) : null, devInfo);
      }
      ...
      class RenderErrorBoundary extends React__namespace.Component {
        ...
        render() {
          return this.state.error !== void 0 ? React__namespace.createElement(RouteContext.Provider, {
            value: this.props.routeContext
          }, React__namespace.createElement(RouteErrorContext.Provider, {
      ...
      function RenderedRoute(_ref) {
        ...
        return React__namespace.createElement(RouteContext.Provider, {
          value: routeContext
        }, children);
      }
      function _renderMatches(matches, parentMatches, dataRouterState, future) {
        ...
        return renderedMatches.reduceRight((outlet, match, index) => {
          ...
          let getChildren = () => {
            ...
            return React__namespace.createElement(RenderedRoute, {
              match,
              routeContext: {
                outlet,
                matches: matches2,
          ...
          return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? React__namespace.createElement(RenderErrorBoundary, {
      ...
      function RouterProvider(_ref) {
        ...
        return React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement(DataRouterContext.Provider, {
          value: dataRouterContext
        }, React__namespace.createElement(DataRouterStateContext.Provider, {
          value: state
        }, React__namespace.createElement(Router, {
          basename,
          location: state.location,
        ...
        }, state.initialized || router$1.future.v7_partialHydration ? React__namespace.createElement(DataRoutes, {
      ...
      function MemoryRouter(_ref3) {
        ...
        return React__namespace.createElement(Router, {
          basename,
          children,
          location: state.location,
      ...
      function Router(_ref5) {
        ...
        return React__namespace.createElement(NavigationContext.Provider, {
          value: navigationContext
        }, React__namespace.createElement(LocationContext.Provider, {
          children,
      ...
      function Await(_ref7) {
        ...
        return React__namespace.createElement(AwaitErrorBoundary, {
          resolve,
          errorElement
      ...
      class AwaitErrorBoundary extends React__namespace.Component {
        ...
        render() {
          ...
          if (status === AwaitRenderStatus.error) {
            return React__namespace.createElement(AwaitContext.Provider, {
              value: promise,
              children: errorElement
            });
          }
...
var require_react_router_dom_development = __commonJS({
  "node_modules/react-router-dom/dist/umd/react-router-dom.development.js"(exports, module) {
    (function(global, factory) {
    ...
    })(exports, function(exports2, React, ReactDOM, reactRouter, router) {
      "use strict";
      function _interopNamespace(e) {
        if (e && e.__esModule)
          return e;
      ...
      const FetchersContext = React__namespace.createContext(/* @__PURE__ */ new Map());
      {
      ...
      function RouterProvider(_ref) {
        ...
        return React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement(reactRouter.UNSAFE_DataRouterContext.Provider, {
          value: dataRouterContext
        }, React__namespace.createElement(reactRouter.UNSAFE_DataRouterStateContext.Provider, {
          value: state
        }, React__namespace.createElement(FetchersContext.Provider, {
          value: fetcherData.current
        }, React__namespace.createElement(ViewTransitionContext.Provider, {
          value: vtContext
        }, React__namespace.createElement(reactRouter.Router, {
          basename,
          location: state.location,
          navigationType: state.historyAction,
          navigator,
      ...
      const Link = React__namespace.forwardRef(function LinkWithRef(_ref7, ref) {
        let {
          onClick,
          relative,
          reloadDocument,
      ...
      const NavLink = React__namespace.forwardRef(function NavLinkWithRef(_ref8, ref) {
        let {
      ...
      function useFetcher(_temp3) {
        ...
        let FetcherForm = React__namespace.useMemo(() => {
          let FetcherForm2 = React__namespace.forwardRef((props, ref) => {
            return React__namespace.createElement(Form, _extends({}, props, {
              navigate: false,
              fetcherKey,
              ref
            }));
